...
export default function CustomCarousel() {
    ...
    <>
        ...
        <Carousel autoPlay infiniteLoop showThumbs={false} interval={5000} className="custom-carousel">
            ...
            <div>
                <img src={cr1} alt="Image 2" className="custom-carousel-image" />
            ...
            <div>
                <img src={cr1} alt="Image 3" className="custom-carousel-image" />
            ...
            <div>
                <img src={cr1} alt="Image 4" className="custom-carousel-image" />
            ...
            <div>
                <img src={cr1} alt="Image 5" className="custom-carousel-image" />
